(function () {
    ...
    var INNER_HTML =
        ...
        +     '<button class="dm-clean-btn" id="dm-clean-old-msgs" style="margin-top:10px;width:100%;padding:10px;border-radius:10px;border:1px solid var(--border-color);background:var(--primary-bg);color:var(--text-secondary);font-size:12px;cursor:pointer;font-family:var(--font-family);transition:all 0.2s;">'
        +       '<i class="fas fa-trash-alt" style="margin-right:6px;"></i>清理旧消息（保留最近100条）'
        +     '</button>'
        +   '</div>'
